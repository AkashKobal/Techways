    ...
    return (
        <>
            <form className="form_container" onSubmit={handleSubmit}>
                ...
                </svg>                <div className="title_container">
                ...
                <div className="input_container">
                    ...
                    <input placeholder="Name" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" value={name} onChange={(e) => setName(e.target.value)} />
                </div>
                <div className="input_container">
                    ...
                    <input placeholder="name@mail.com" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
                <div className="input_container">
                    ...
                    <input placeholder="Password" title="Inpit title" name="input-name" type="password" className="input_field" id="password_field" value={password} onChange={(e) => setPassword(e.target.value)} />
                </div>
                <button title="Sign In" type="submit" className="sign-in_btn">
                    <span>Register</span>
                </button>
                <label className="input_label" htmlFor="password_field">Already have an account ? <a href="/login">Login</a></label>
            </form>
        </>
    )
